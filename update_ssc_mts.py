...
new_meta = """<meta name="description" content="SSC MTS Recruitment 2026 Notification Out! Apply Online for 9,583+ Havaldar Vacancies. Check exam date, syllabus, age limit, and official PDF link before the last date.">
  ...
  <title>【Alert】 SSC MTS Recruitment 2026: Apply Online, Syllabus, Exam Date</title>"""
...
new_body = """
        <section class="service-section">
          <h2 class="service-section__title" style="color: #ef4444; font-weight: 800;">🚨 SSC MTS 2026 Notification OUT: Apply Online for 9,583+ Vacancies</h2>
...
# Extract the body content container. This assumes it's within a specific block. We will replace everything between `<main class="main-content">` and `</main>` or similar.
# Wait, let's just replace the content between `<main id="main-content" class="page-container">` and `</main>` or the `service-section` div.
