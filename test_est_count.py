...
resp = requests.head(f"{URL}/csc_centers?state=ilike.*maharashtra*&district=ilike.*nagpur*&limit=1", headers=headers)
print("Estimated count status:", resp.status_code)
print("Range:", resp.headers.get('Content-Range'))
